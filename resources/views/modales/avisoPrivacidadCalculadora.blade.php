        ...
        <div class="modal-content">
            <div class="modal-header" style="background: #337ab7; color: #ffff;">
                ...
                <button type="button" class="btn btn-warning" data-bs-dismiss="modal"
                    style="color: red; font-size: 20px;" aria-label="Close">
            ...
            <div class="modal-body" style="color: #337ab7">
                ...
                <br><br>
                <a target="_blank" href="https://testing.nuevo.unimex.edu.mx/">unimex.edu.mx</a> o <a target="_blank" href="https://testing.nuevo.unimexver.edu.mx/">unimexver.edu.mx</a>
                </p>
            </div>
        </div>
    </div>
